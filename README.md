...
![Website heading with font Great Vibes](./media_readme/FFS_GreatVibes.png)

![Website heading with font Gloria Hallelujah](./media_readme/FFS_GloriaHallelujah.png)

![Website heading with font Smile](./media_readme/FFS_Smile.png)
...
![Example wireframe](./media_readme/Wireframe.png)
...
![Picture of favicon](./media_readme/Features_favicon.png)
...
![Anxious monster on landing page](./media_readme/Real_Face_1.png)
...
![W3C Validator report for landing page](./media_readme/W3C_Validator_index.png)

#### Fun Facts page

![W3C Validator report for fun facts page](./media_readme/W3C_Validator_fun_facts.png)
...
![W3C Validator warning for the css file](./media_readme/W3C_Validator_csswarning.png)
...
- I added a title to the Wikipedia iframe.
  ...
  ![Lighthouse report for the fun facts page](./media_readme/Accessibility_fun_facts.png)
...
- __Just before submission__, I saw on the checklist for submission a video or an audio embed as one of the requirements. The accessibility score did not change after adding the video frame, but it lowered down the "best practices" score due to high amount of cookies. Below is a screenshot
  ...
  ![Lighthouse report for the fun facts page after embedding YouTube video](./media_readme/Accessibility_fun_facts_v2.png)
...
![Deployment stages](./media_readme/Deployment.png)
...
![Creating a branch on GitHub - step 2](./media_readme/Create_branch_2.png)

![Creating a branch on GitHub - step 3](./media_readme/Create_branch_3.png)

![Creating a branch on GitHub - updated page](./media_readme/Create_branch_4.png)
